...
<template>
  ...
  >
    <div
      class="screen-wrapper bg-white rounded-xl w-[370px] h-[720px] flex flex-col"
    >
      <div
      ...
      >
        ...
        >
          <div class="username-form basis-2/5 flex flex-col relative pt-4">
            ...
            <svg
              class="username-icon text-gray-400 absolute bottom-[24px] h-5 w-5 left-2"
          ...
          <div class="password-form basis-2/5 flex flex-col relative pt-2">
            ...
            <svg
              class="username-icon text-gray-400 absolute bottom-[32px] h-5 w-5 left-2"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke-width="1.5"
          ...
          <button
            type="submit"
            class="form-login basis-1/5 mb-0 mt-2 bg-pink-500 hover:bg-pink-600 rounded-3xl"
          >
            Login
          </button>
        </form>
      ...
      <div
        class="other-choise basis-2/6 flex flex-col justify-start items-center"
      >
      ...
      <div
        class="sign-up basis-1/6 flex flex-col justify-start items-center gap-3"
      >
        <h4 class="text-gray-500">Or Sign Up Using</h4>
